      ...
      <section className="bg-white pt-8 pb-16 md:pt-10 md:pb-20">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center mb-8">
            ...
            <h2 className="font-serif text-2xl sm:text-3xl md:text-4xl font-medium leading-[1.1] tracking-wide text-center mb-6" style={{ wordSpacing: '0.06em' }}>A Taste Of What We Bring To Your Event</h2>
          </div>
