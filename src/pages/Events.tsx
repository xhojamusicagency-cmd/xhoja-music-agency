      ...
      <section className="bg-white py-8 md:py-12">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center mb-8">
            ...
            <h2 className="font-serif text-2xl sm:text-3xl md:text-4xl font-medium leading-[1.1] tracking-normal text-center mb-6" style={{ wordSpacing: '-2px' }}>A Taste Of What We Bring To Your Event</h2>
          </div>
